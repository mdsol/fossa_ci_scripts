...
install_fossa()
{
  ...
  if ! curl -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/fossas/fossa-cli/master/install.sh | bash -s -- -b "$WORKSPACE"; then
...
echo "           PLEASE SEE :"
echo "  https://github.com/mdsol/fossa_ci_scripts/blob/main/jenkins/SETUP.md"
echo "******************************************************************"
